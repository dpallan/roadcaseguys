...
/*Table structure for table `rcg_assets` */

DROP TABLE IF EXISTS `rcg_assets`;

CREATE TABLE `rcg_assets` (
...
/*Data for the table `rcg_assets` */

insert  into `rcg_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values 
...
/*Table structure for table `rcg_associations` */

DROP TABLE IF EXISTS `rcg_associations`;

CREATE TABLE `rcg_associations` (
...
/*Data for the table `rcg_associations` */

/*Table structure for table `rcg_banner_clients` */

DROP TABLE IF EXISTS `rcg_banner_clients`;

CREATE TABLE `rcg_banner_clients` (
...
/*Data for the table `rcg_banner_clients` */

/*Table structure for table `rcg_banner_tracks` */

DROP TABLE IF EXISTS `rcg_banner_tracks`;

CREATE TABLE `rcg_banner_tracks` (
...
/*Data for the table `rcg_banner_tracks` */

/*Table structure for table `rcg_banners` */

DROP TABLE IF EXISTS `rcg_banners`;

CREATE TABLE `rcg_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rcg_banners` */

/*Table structure for table `rcg_categories` */

DROP TABLE IF EXISTS `rcg_categories`;

CREATE TABLE `rcg_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rcg_categories` */

insert  into `rcg_categories`(`id`,`asset_id`,`parent_id`,`lft`,`rgt`,`level`,`path`,`extension`,`title`,`alias`,`note`,`description`,`published`,`checked_out`,`checked_out_time`,`access`,`params`,`metadesc`,`metakey`,`metadata`,`created_user_id`,`created_time`,`modified_user_id`,`modified_time`,`hits`,`language`,`version`) values 
...
/*Table structure for table `rcg_contact_details` */

DROP TABLE IF EXISTS `rcg_contact_details`;

CREATE TABLE `rcg_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
/*Data for the table `rcg_contact_details` */

/*Table structure for table `rcg_content` */

DROP TABLE IF EXISTS `rcg_content`;

CREATE TABLE `rcg_content` (
...
/*Data for the table `rcg_content` */

/*Table structure for table `rcg_content_frontpage` */

DROP TABLE IF EXISTS `rcg_content_frontpage`;

CREATE TABLE `rcg_content_frontpage` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`content_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `rcg_content_frontpage` */

/*Table structure for table `rcg_content_rating` */

DROP TABLE IF EXISTS `rcg_content_rating`;

CREATE TABLE `rcg_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
/*Data for the table `rcg_content_rating` */

/*Table structure for table `rcg_content_types` */

DROP TABLE IF EXISTS `rcg_content_types`;

CREATE TABLE `rcg_content_types` (
...
/*Data for the table `rcg_content_types` */

insert  into `rcg_content_types`(`type_id`,`type_title`,`type_alias`,`table`,`rules`,`field_mappings`,`router`,`content_history_options`) values 
...
/*Table structure for table `rcg_contentitem_tag_map` */

DROP TABLE IF EXISTS `rcg_contentitem_tag_map`;

CREATE TABLE `rcg_contentitem_tag_map` (
...
/*Data for the table `rcg_contentitem_tag_map` */

/*Table structure for table `rcg_core_log_searches` */

DROP TABLE IF EXISTS `rcg_core_log_searches`;

CREATE TABLE `rcg_core_log_searches` (
  `search_term` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `rcg_core_log_searches` */

/*Table structure for table `rcg_extensions` */

DROP TABLE IF EXISTS `rcg_extensions`;

CREATE TABLE `rcg_extensions` (
...
/*Data for the table `rcg_extensions` */

insert  into `rcg_extensions`(`extension_id`,`name`,`type`,`element`,`folder`,`client_id`,`enabled`,`access`,`protected`,`manifest_cache`,`params`,`custom_data`,`system_data`,`checked_out`,`checked_out_time`,`ordering`,`state`) values 
...
(103,'Joomla! Platform','library','joomla','',0,1,1,1,'{\"name\":\"Joomla! Platform\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}','{\"mediaversion\":\"9f1b81ac8011513a0ffc9c4afa3555c0\"}','','',0,'0000-00-00 00:00:00',0,0),
...
(452,'plg_system_updatenotification','plugin','updatenotification','system',0,1,1,0,'{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}','{\"lastrun\":1460414137}','','',0,'0000-00-00 00:00:00',0,0),
...
/*Table structure for table `rcg_finder_filters` */

DROP TABLE IF EXISTS `rcg_finder_filters`;

CREATE TABLE `rcg_finder_filters` (
...
/*Data for the table `rcg_finder_filters` */

/*Table structure for table `rcg_finder_links` */

DROP TABLE IF EXISTS `rcg_finder_links`;

CREATE TABLE `rcg_finder_links` (
...
/*Data for the table `rcg_finder_links` */

/*Table structure for table `rcg_finder_links_terms0` */

DROP TABLE IF EXISTS `rcg_finder_links_terms0`;

CREATE TABLE `rcg_finder_links_terms0` (
...
/*Data for the table `rcg_finder_links_terms0` */

/*Table structure for table `rcg_finder_links_terms1` */

DROP TABLE IF EXISTS `rcg_finder_links_terms1`;

CREATE TABLE `rcg_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_terms1` */

/*Table structure for table `rcg_finder_links_terms2` */

DROP TABLE IF EXISTS `rcg_finder_links_terms2`;

CREATE TABLE `rcg_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_terms2` */

/*Table structure for table `rcg_finder_links_terms3` */

DROP TABLE IF EXISTS `rcg_finder_links_terms3`;

CREATE TABLE `rcg_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_terms3` */

/*Table structure for table `rcg_finder_links_terms4` */

DROP TABLE IF EXISTS `rcg_finder_links_terms4`;

CREATE TABLE `rcg_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_terms4` */

/*Table structure for table `rcg_finder_links_terms5` */

DROP TABLE IF EXISTS `rcg_finder_links_terms5`;

CREATE TABLE `rcg_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_terms5` */

/*Table structure for table `rcg_finder_links_terms6` */

DROP TABLE IF EXISTS `rcg_finder_links_terms6`;

CREATE TABLE `rcg_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_terms6` */

/*Table structure for table `rcg_finder_links_terms7` */

DROP TABLE IF EXISTS `rcg_finder_links_terms7`;

CREATE TABLE `rcg_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_terms7` */

/*Table structure for table `rcg_finder_links_terms8` */

DROP TABLE IF EXISTS `rcg_finder_links_terms8`;

CREATE TABLE `rcg_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_terms8` */

/*Table structure for table `rcg_finder_links_terms9` */

DROP TABLE IF EXISTS `rcg_finder_links_terms9`;

CREATE TABLE `rcg_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_terms9` */

/*Table structure for table `rcg_finder_links_termsa` */

DROP TABLE IF EXISTS `rcg_finder_links_termsa`;

CREATE TABLE `rcg_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_termsa` */

/*Table structure for table `rcg_finder_links_termsb` */

DROP TABLE IF EXISTS `rcg_finder_links_termsb`;

CREATE TABLE `rcg_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_termsb` */

/*Table structure for table `rcg_finder_links_termsc` */

DROP TABLE IF EXISTS `rcg_finder_links_termsc`;

CREATE TABLE `rcg_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_termsc` */

/*Table structure for table `rcg_finder_links_termsd` */

DROP TABLE IF EXISTS `rcg_finder_links_termsd`;

CREATE TABLE `rcg_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_termsd` */

/*Table structure for table `rcg_finder_links_termse` */

DROP TABLE IF EXISTS `rcg_finder_links_termse`;

CREATE TABLE `rcg_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_termse` */

/*Table structure for table `rcg_finder_links_termsf` */

DROP TABLE IF EXISTS `rcg_finder_links_termsf`;

CREATE TABLE `rcg_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
/*Data for the table `rcg_finder_links_termsf` */

/*Table structure for table `rcg_finder_taxonomy` */

DROP TABLE IF EXISTS `rcg_finder_taxonomy`;

CREATE TABLE `rcg_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
/*Data for the table `rcg_finder_taxonomy` */

insert  into `rcg_finder_taxonomy`(`id`,`parent_id`,`title`,`state`,`access`,`ordering`) values 
(1,0,'ROOT',0,0,0);

/*Table structure for table `rcg_finder_taxonomy_map` */

DROP TABLE IF EXISTS `rcg_finder_taxonomy_map`;

CREATE TABLE `rcg_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
/*Data for the table `rcg_finder_taxonomy_map` */

/*Table structure for table `rcg_finder_terms` */

DROP TABLE IF EXISTS `rcg_finder_terms`;

CREATE TABLE `rcg_finder_terms` (
...
/*Data for the table `rcg_finder_terms` */

/*Table structure for table `rcg_finder_terms_common` */

DROP TABLE IF EXISTS `rcg_finder_terms_common`;

CREATE TABLE `rcg_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
/*Data for the table `rcg_finder_terms_common` */

insert  into `rcg_finder_terms_common`(`term`,`language`) values 
('a','en'),
('about','en'),
('after','en'),
('ago','en'),
...
/*Table structure for table `rcg_finder_tokens` */

DROP TABLE IF EXISTS `rcg_finder_tokens`;

CREATE TABLE `rcg_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
/*Data for the table `rcg_finder_tokens` */

/*Table structure for table `rcg_finder_tokens_aggregate` */

DROP TABLE IF EXISTS `rcg_finder_tokens_aggregate`;

CREATE TABLE `rcg_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
/*Data for the table `rcg_finder_tokens_aggregate` */

/*Table structure for table `rcg_finder_types` */

DROP TABLE IF EXISTS `rcg_finder_types`;

CREATE TABLE `rcg_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rcg_finder_types` */

/*Table structure for table `rcg_languages` */

DROP TABLE IF EXISTS `rcg_languages`;

CREATE TABLE `rcg_languages` (
...
/*Data for the table `rcg_languages` */

insert  into `rcg_languages`(`lang_id`,`lang_code`,`title`,`title_native`,`sef`,`image`,`description`,`metakey`,`metadesc`,`sitename`,`published`,`access`,`ordering`) values 
(1,'en-GB','English (UK)','English (UK)','en','en','','','','',1,1,1);

/*Table structure for table `rcg_menu` */

DROP TABLE IF EXISTS `rcg_menu`;

CREATE TABLE `rcg_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rcg_menu` */

insert  into `rcg_menu`(`id`,`menutype`,`title`,`alias`,`note`,`path`,`link`,`type`,`published`,`parent_id`,`level`,`component_id`,`checked_out`,`checked_out_time`,`browserNav`,`access`,`img`,`template_style_id`,`params`,`lft`,`rgt`,`home`,`language`,`client_id`) values 
...
/*Table structure for table `rcg_menu_types` */

DROP TABLE IF EXISTS `rcg_menu_types`;

CREATE TABLE `rcg_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rcg_menu_types` */

insert  into `rcg_menu_types`(`id`,`menutype`,`title`,`description`) values 
(1,'mainmenu','Main Menu','The main menu for the site');

/*Table structure for table `rcg_messages` */

DROP TABLE IF EXISTS `rcg_messages`;

CREATE TABLE `rcg_messages` (
...
/*Data for the table `rcg_messages` */

/*Table structure for table `rcg_messages_cfg` */

DROP TABLE IF EXISTS `rcg_messages_cfg`;

CREATE TABLE `rcg_messages_cfg` (
...
/*Data for the table `rcg_messages_cfg` */

/*Table structure for table `rcg_modules` */

DROP TABLE IF EXISTS `rcg_modules`;

CREATE TABLE `rcg_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
/*Data for the table `rcg_modules` */

insert  into `rcg_modules`(`id`,`asset_id`,`title`,`note`,`content`,`ordering`,`position`,`checked_out`,`checked_out_time`,`publish_up`,`publish_down`,`published`,`module`,`access`,`showtitle`,`params`,`client_id`,`language`) values 
...
/*Table structure for table `rcg_modules_menu` */

DROP TABLE IF EXISTS `rcg_modules_menu`;

CREATE TABLE `rcg_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`moduleid`,`menuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `rcg_modules_menu` */

insert  into `rcg_modules_menu`(`moduleid`,`menuid`) values 
(1,0),
(2,0),
(3,0),
(4,0),
...
/*Table structure for table `rcg_newsfeeds` */

DROP TABLE IF EXISTS `rcg_newsfeeds`;

CREATE TABLE `rcg_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rcg_newsfeeds` */

/*Table structure for table `rcg_overrider` */

DROP TABLE IF EXISTS `rcg_overrider`;

CREATE TABLE `rcg_overrider` (
...
/*Data for the table `rcg_overrider` */

/*Table structure for table `rcg_postinstall_messages` */

DROP TABLE IF EXISTS `rcg_postinstall_messages`;

CREATE TABLE `rcg_postinstall_messages` (
...
/*Data for the table `rcg_postinstall_messages` */

insert  into `rcg_postinstall_messages`(`postinstall_message_id`,`extension_id`,`title_key`,`description_key`,`action_key`,`language_extension`,`language_client_id`,`type`,`action_file`,`action`,`condition_file`,`condition_method`,`version_introduced`,`enabled`) values 
...
/*Table structure for table `rcg_redirect_links` */

DROP TABLE IF EXISTS `rcg_redirect_links`;

CREATE TABLE `rcg_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rcg_redirect_links` */

/*Table structure for table `rcg_schemas` */

DROP TABLE IF EXISTS `rcg_schemas`;

CREATE TABLE `rcg_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`extension_id`,`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `rcg_schemas` */

insert  into `rcg_schemas`(`extension_id`,`version_id`) values 
(700,'3.5.1-2016-03-29');

/*Table structure for table `rcg_session` */

DROP TABLE IF EXISTS `rcg_session`;

CREATE TABLE `rcg_session` (
...
/*Data for the table `rcg_session` */

insert  into `rcg_session`(`session_id`,`client_id`,`guest`,`time`,`data`,`userid`,`username`) values 
('bhgqge66ns74on8r26evq0hf62',0,1,'1460414156','joomla|s:1552:\"\";',0,''),
('ujbd8bmgg8d9hcufdi68chchb0',1,0,'1460414211','joomla|s:2056:\"\";',187,'admin');

/*Table structure for table `rcg_tags` */

DROP TABLE IF EXISTS `rcg_tags`;

CREATE TABLE `rcg_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
/*Table structure for table `rcg_template_styles` */

DROP TABLE IF EXISTS `rcg_template_styles`;

CREATE TABLE `rcg_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rcg_template_styles` */

insert  into `rcg_template_styles`(`id`,`template`,`client_id`,`home`,`title`,`params`) values 
(4,'beez3',0,'0','Beez3 - Default','{\"wrapperSmall\":\"53\",\"wrapperLarge\":\"72\",\"logo\":\"images\\/joomla_black.png\",\"sitetitle\":\"Joomla!\",\"sitedescription\":\"Open Source Content Management\",\"navposition\":\"left\",\"templatecolor\":\"personal\",\"html5\":\"0\"}'),
(5,'hathor',1,'0','Hathor - Default','{\"showSiteName\":\"0\",\"colourChoice\":\"\",\"boldText\":\"0\"}'),
(7,'protostar',0,'1','protostar - Default','{\"templateColor\":\"\",\"logoFile\":\"\",\"googleFont\":\"1\",\"googleFontName\":\"Open+Sans\",\"fluidContainer\":\"0\"}'),
(8,'isis',1,'1','isis - Default','{\"templateColor\":\"\",\"logoFile\":\"\"}');

/*Table structure for table `rcg_ucm_base` */

DROP TABLE IF EXISTS `rcg_ucm_base`;

CREATE TABLE `rcg_ucm_base` (
...
/*Data for the table `rcg_ucm_base` */

/*Table structure for table `rcg_ucm_content` */

DROP TABLE IF EXISTS `rcg_ucm_content`;

CREATE TABLE `rcg_ucm_content` (
...
/*Data for the table `rcg_ucm_content` */

/*Table structure for table `rcg_ucm_history` */

DROP TABLE IF EXISTS `rcg_ucm_history`;

CREATE TABLE `rcg_ucm_history` (
...
/*Data for the table `rcg_ucm_history` */

/*Table structure for table `rcg_update_sites` */

DROP TABLE IF EXISTS `rcg_update_sites`;

CREATE TABLE `rcg_update_sites` (
...
/*Data for the table `rcg_update_sites` */

insert  into `rcg_update_sites`(`update_site_id`,`name`,`type`,`location`,`enabled`,`last_check_timestamp`,`extra_query`) values 
(1,'Joomla! Core','collection','http://update.joomla.org/core/list.xml',1,1460414148,''),
(2,'Joomla! Extension Directory','collection','http://update.joomla.org/jed/list.xml',1,1460414148,''),
...
/*Table structure for table `rcg_update_sites_extensions` */

DROP TABLE IF EXISTS `rcg_update_sites_extensions`;

CREATE TABLE `rcg_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`update_site_id`,`extension_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

/*Data for the table `rcg_update_sites_extensions` */

insert  into `rcg_update_sites_extensions`(`update_site_id`,`extension_id`) values 
(1,700),
(2,700),
(3,600),
(4,28);

/*Table structure for table `rcg_updates` */

DROP TABLE IF EXISTS `rcg_updates`;

CREATE TABLE `rcg_updates` (
...
/*Data for the table `rcg_updates` */

/*Table structure for table `rcg_user_keys` */

DROP TABLE IF EXISTS `rcg_user_keys`;

CREATE TABLE `rcg_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rcg_user_keys` */

/*Table structure for table `rcg_user_notes` */

DROP TABLE IF EXISTS `rcg_user_notes`;

CREATE TABLE `rcg_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
/*Data for the table `rcg_user_notes` */

/*Table structure for table `rcg_user_profiles` */

DROP TABLE IF EXISTS `rcg_user_profiles`;

CREATE TABLE `rcg_user_profiles` (
...
/*Data for the table `rcg_user_profiles` */

/*Table structure for table `rcg_user_usergroup_map` */

DROP TABLE IF EXISTS `rcg_user_usergroup_map`;

CREATE TABLE `rcg_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id',
  PRIMARY KEY (`user_id`,`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `rcg_user_usergroup_map` */

insert  into `rcg_user_usergroup_map`(`user_id`,`group_id`) values 
(187,8);

/*Table structure for table `rcg_usergroups` */

DROP TABLE IF EXISTS `rcg_usergroups`;

CREATE TABLE `rcg_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
/*Data for the table `rcg_usergroups` */

insert  into `rcg_usergroups`(`id`,`parent_id`,`lft`,`rgt`,`title`) values 
(1,0,1,18,'Public'),
(2,1,8,15,'Registered'),
(3,2,9,14,'Author'),
(4,3,10,13,'Editor'),
...
/*Table structure for table `rcg_users` */

DROP TABLE IF EXISTS `rcg_users`;

CREATE TABLE `rcg_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rcg_users` */

insert  into `rcg_users`(`id`,`name`,`username`,`email`,`password`,`block`,`sendEmail`,`registerDate`,`lastvisitDate`,`activation`,`params`,`lastResetTime`,`resetCount`,`otpKey`,`otep`,`requireReset`) values 
(187,'Super User','admin','dave.allan@davsus.com','$2y$10$yZCOwbhBtoOJ4IcB.ZWPhuqt6S8jAq4auH.V5Kxe98WYImBQnxEGW',0,1,'2016-04-11 22:35:25','2016-04-11 22:35:45','0','','0000-00-00 00:00:00',0,'','',0);

/*Table structure for table `rcg_utf8_conversion` */

DROP TABLE IF EXISTS `rcg_utf8_conversion`;

CREATE TABLE `rcg_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `rcg_utf8_conversion` */

insert  into `rcg_utf8_conversion`(`converted`) values 
(2);

/*Table structure for table `rcg_viewlevels` */

DROP TABLE IF EXISTS `rcg_viewlevels`;

CREATE TABLE `rcg_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
/*Data for the table `rcg_viewlevels` */

insert  into `rcg_viewlevels`(`id`,`title`,`ordering`,`rules`) values 
(1,'Public',0,'[1]'),
